pipeline {
  ...
  environment {
    ...
    EXT_GIT_BRANCH = 'main'
    EXT_USER = 'Lodestone-Team'
    EXT_REPO = 'lodestone_core'
    BUILD_VERSION_ARG = 'LODESTONE_VERSION'
    IG_USER = 'imagegenius'
    IG_REPO = 'docker-lodestone'
    CONTAINER_NAME = 'lodestone'
    DOCKERHUB_IMAGE = 'imagegenius/lodestone'
    DEV_DOCKERHUB_IMAGE = 'igdev/lodestone'
    PR_DOCKERHUB_IMAGE = 'igpipepr/lodestone'
    DIST_IMAGE = 'alpine'
    MULTIARCH = 'false'
    CI = 'true'
    CI_WEB = 'true'
    ...
    stage('Build-Single') {
      ...
      steps {
        ...
        sh "docker build \
          ...
          --label \"org.opencontainers.image.url=https://github.com/imagegenius/docker-lodestone/packages\" \
          --label \"org.opencontainers.image.source=https://github.com/imagegenius/docker-lodestone\" \
          ...
          --label \"org.opencontainers.image.description=[Lodestone](https://www.lodestone.cc/) Don't use  \" \
